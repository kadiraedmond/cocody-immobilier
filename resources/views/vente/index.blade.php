  ...
  <div class="col-lg-10" style=" background:linear-gradient(90deg, #ffffff 0%, rgb(48 151 165) 100%);border-radius: 10px; height: 60px; ">
    <div class="row g-1">
      ...
      <div class="col-4">
        <div class="row g-1">
          <div class="col-6">
            <h4 style="font-size: 17px; margin-top:19px">Vendus</h4>
          </div>
          <div class="col-6">
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="{{ url('vente-detail/'.$item->id)}}"
                            ><i class="bx bx-edit-alt me-1"></i> Voir</a
                          >
                          <a class="dropdown-item" href="{{ url('edit-vente/'.$item->id) }}"
                            ><i class="bx bx-edit-alt me-1"></i> Modifier</a
                          >
                          <form action="{{ url('delete-vente/'.$item->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                          ...
                          @if ($item->status==1)
                            <a class="dropdown-item" href="{{url('/desactiver_ven/'.$item->id)}}"
                            ><i class="bx bx-trash me-1"></i>Désactiver</a>
                          @else

                          <a class="dropdown-item" href="{{url('/activer_ven/'.$item->id)}}"
