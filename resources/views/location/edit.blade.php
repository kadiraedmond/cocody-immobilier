...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Location/</span> Modifier un bien en location</h4>
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-4">
                    Location
                    <div class="card-body">
                        <form action="{{ url('update-location/'.$Location->id) }}" method="POST" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            >{{ $Location->presentation }}</textarea>
                          </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Adresse</label>
                          <input type="text" name="adresse"   value="{{ $Location->adresse }}" class="form-control" id="basic-default-company" />
                        </div>
                       
                          <div class="mb-3">
                            <label for="defaultSelect" class="form-label">Configuration </label>
                            <select id="defaultSelect" name="configuration"  class="form-select">
                                <option value="{{ $Location->configuration }}">{{ $Location->configuration }}</option>
                              <option value="studio">Studio</option>
                          ...
                          <div class="mb-3">
                            <label for="defaultSelect" class="form-label">Usage </label>
                            <select id="defaultSelect" name="usage" class="form-select">
                              <option value="{{ $Location->usage }}">{{ $Location->usage }}</option>
                              <option value="habitation">Habitation</option>
                              <option value="bureaux">Bureaux</option>
                              <option value="habit_bureau">Habitation & Bureaux </option>
                        ...
                        <div class="mb-3">
                          ...
                          <select id="defaultSelect" name="niveau" class="form-select">
                            <option value="{{ $Location->climatisation }}">{{ $Location->climatisation }}</option>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="mb-3">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                />
                                <img src="{{ asset('uploads/Location/'.$Location->images) }}" width="70px" height="70px" alt="Image">
                              </div>
                          </div>
                          </div>
                          <div class="col-md-4">
                            <div class="mb-3">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <input
                                  ...
                                  aria-describedby="basic-icon-default-fullname2"
                                />
                                <img src="{{ asset('uploads/Location/'.$Location->image) }}" width="70px" height="70px" alt="Image">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="mb-3">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <input
                                  ...
                                  aria-describedby="basic-icon-default-fullname2"
                                />
                                <img src="{{ asset('uploads/Location/'.$Location->ima) }}" width="70px" height="70px" alt="Image">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="mb-3">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <input
                                  ...
                                  aria-describedby="basic-icon-default-fullname2"
                                />
                                <img src="{{ asset('uploads/Location/'.$Location->im) }}" width="70px" height="70px" alt="Image">
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="mb-3">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <input
                                  ...
                                  aria-describedby="basic-icon-default-fullname2"
                                />
                                <img src="{{ asset('uploads/Location/'.$Location->picture) }}" width="70px" height="70px" alt="Image">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="mb-3">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <input
                                  ...
                                  aria-describedby="basic-icon-default-fullname2"
                                />
                                <img src="{{ asset('uploads/Location/'.$Location->pictur) }}" width="70px" height="70px" alt="Image">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="mb-3">
                              ...
                              <div class="input-group input-group-merge">
                                ...
                                <input
                                  ...
                                  aria-describedby="basic-icon-default-fullname2"
                                />
                                <img src="{{ asset('uploads/Location/'.$Location->pict) }}" width="70px" height="70px" alt="Image">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                ...
                                aria-describedby="basic-icon-default-fullname2"
                              />
                              <img src="{{ asset('uploads/Location/'.$Location->videos) }}" width="70px" height="70px" alt="Image">
                            </div>
                        </div>
                        {{-- <div class="mb-3">
                        ...
                        <H2 style="font-size: 21px;">Condition </H2>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="basic-icon-default-email">Caution</label>
                                <div class="input-group input-group-merge">
                                  <input
                                    type="text"
                                    id="basic-icon-default-email"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="basic-icon-default-email">Avance</label>
                                <div class="input-group input-group-merge">
                                  <input
                                    type="text"
                                    id="basic-icon-default-email"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                            ...
                                            <input
                                                ...
                                                aria-describedby="basic-icon-default-fullname2"
                                            />
                                            <img src="{{ asset('uploads/Location/'.$Location->resp_images) }}" width="70px" height="70px" alt="Image">
                                            </div>
                                </div>
                            </div>
                            <div class="col-md-6">
