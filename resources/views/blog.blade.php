...
<div class="row">
    <div class="col-lg-2">
      <a href="add_blog.html">
          <button class="btn btn-primary mb-2" style="border-radius: 10px; width: 150px; height: 69px;font-size: 19px; margin-top: 10px;"> Ajouter</button>
      </a>
      
    </div>
    <div class="col-lg-10" style=" background:linear-gradient(90deg, #ffffff 0%, rgb(48 151 165) 100%);border-radius: 10px;">
