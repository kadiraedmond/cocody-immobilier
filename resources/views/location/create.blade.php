...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Location/</span> Ajouter un bien en location</h4>
                    ...
                    <div class="card-body">
                        <form action="{{ url('add-location') }}" method="POST" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                            ...
                            <select id="defaultSelect" name="type" class="form-select" required>
                              <option></option>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" name="adresse" class="form-control" id="basic-default-company" required />
                        </div>
                       
                          <div class="mb-3">
                            <label for="defaultSelect" class="form-label">Configuration </label>
                            <select id="defaultSelect" name="configuration"  class="form-select" required>
                              <option></option>
                              <option value="studio">Studio</option>
                          ...
                          <div class="mb-3">
                            ...
                            <select id="defaultSelect" name="usage" class="form-select" required>
                              <option></option>
                        ...
                        <div class="mb-3">
                          ...
                          <select id="defaultSelect" name="niveau" class="form-select" required>
                            <option></option>
