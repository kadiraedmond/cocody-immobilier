...
<section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
      ...
      <ol>
        <li><a href="index.html">Les biens</a></li>
        <li> </li>
      </ol>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="row" style="background: #f1f3ff; padding: 20px; border-radius: 5px;">
                <div class="col-md-12">
                  <form class="row g-3 needs-validation" method="post" action="{{ url('filtrerss') }}">
                    @csrf
                    <div class="col-md-3">
